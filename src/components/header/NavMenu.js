    ...
    >
      <nav>
        <ul>
          ...
          <li>
            <Link to={process.env.PUBLIC_URL + "/shop-grid-standard"} style={styles}>
              {" "}
              {strings["shop"]}
              {sidebarMenu ? (
                <span>
          ...
          <li>
            <Link to={process.env.PUBLIC_URL + "/blog-standard"} style={styles}>
              {strings["blog"]}
              {sidebarMenu ? (
                <span>
                  <i className="fa fa-angle-right"></i>
          ...
          <li>
            <Link to={process.env.PUBLIC_URL + "/contact"} style={styles}>
              {strings["contact_us"]}
            </Link>
          </li>
        </ul>
